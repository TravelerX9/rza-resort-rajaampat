...
(($, i, m, l, u, h) => {
    ...
    ThemifyBuilderModuleJs = {
        isBpMobile: !m.is_builder_active && m.w < parseInt(h.breakpoints.tablet[1]),
        init() {
            if (this.jsUrl = m.builder_url + 'js/modules/', this.cssUrl = m.builder_url + 'css/modules/', h.addons = Object.assign(h.addons, {
                    bgzs: {
                        match: '[data-zoom-bg]',
                        js: 'bgzoom_scroll'
                    },
                ...
                }), (h.is_parallax === u || !0 === this.isBpMobile && 'm' === h.is_parallax) && (h.addons.p = {
                ...
                e[0] !== u && (0 < i.pageYOffset ? this.stickyElementInit(e) : i.tfOn('scroll', () => {
            ...
            m.trigger('themify_builder_loaded'), m.is_builder_loaded = !0
        },
        async wow(t, s) {
            if (t && '' !== h.is_animation && (!0 !== this.isBpMobile || 'm' !== h.is_animation)) {
                ...
                else e = m.selectWithParent('.hover-wow,[data-tf-animation]', t);
                e[0] !== u && (await m.wow(), m.trigger('tf_wow_init', [e]))
            }
        },
        async initScrollHighlight(t, e) {
            if (!(!0 === e || !0 === m.is_builder_active || h.scrollHighlight && 'external' === h.scrollHighlight.scroll)) {
                let e = t ? 0 < m.selectWithParent('[data-anchor]', t).length : null !== l.querySelector('[data-anchor]');
                if (!1 === e) {
                    const s = i.location.hash.replace('#', '');
                    '' !== s && '#' !== s && (e = null !== l.querySelector('[data-id="' + CSS.escape(s) + '"]'))
                }!0 === e && (await m.loadJs(m.builder_url + 'js/themify.scroll-highlight'), m.trigger('tb_init_scroll_highlight', [t]))
            }
        },
        async toc() {
            const e = i.location.hash.replace('#', '');
            if ('' !== e) {
                const t = l.tfClass('module-toc');
                for (let e = t.length - 1; - 1 < e; --e) this.addonLoad(t[e], null, !0)
            }
        },
        async addonLoad(r, c, n) {
            if (h.addons && 0 < Object.keys(h.addons).length) {
                let e = {};
                if (c && r && r.tfClass('themify_builder')[0] === u) {
                ...
                for (let o in e) {
                    let t = !1,
                        a = e[o];
                    if (a.selector !== u || a.match !== u)
                        if (!0 === n) t = a.match !== u ? r.matches(a.match) : r.matches(a.selector) || null !== r.querySelector(a.selector);
                        else {
                            let e = a.selector || a.match;
                            t = null !== l.querySelector(e.replaceAll(':scope>', ''))
                        }
                    else t = !0 === n ? r.classList.contains('module-' + o) : l.tfClass('module-' + o)[0] !== u;
                    if (!0 === t) {
                        let i = [],
                            s = 'tb_' + o,
                            l = 1 === a ? null : a.ver;
                        if (a.css !== u && !m.cssLazy.has(s)) {
                            let t = a.css;
                            if (1 === t || 'string' == typeof t) 1 !== t && -1 !== t.indexOf('http') || (t = this.cssUrl + (1 === t ? o : a.css)), i.push(m.loadCss(t, s, l));
                            else
                                for (let e = a.css.length - 1; - 1 < e; --e) 1 !== (t = a.css[e]) && -1 !== t.indexOf('http') || (t = this.cssUrl + (1 === t ? o : a.css[e])), i.push(m.loadCss(t, s + e, l))
                        }
                        if (a.js !== u) {
                            let e = r ? r.classList : null,
                                t = a.js,
                                s = (e && (e.contains('module') || e.contains('active_module')) && e.add('tf_lazy'), 1 !== t && -1 !== t.indexOf('http') || (t = this.jsUrl + (1 === t ? o : a.js)), i.push(m.loadJs(t, null, l)), Promise.all(i));
                            s.then(() => {
                                delete h.addons[o], e && (m.trigger('builder_load_module_partial', [r, n]), e.remove('tf_lazy'))
                            }), d.push(s)
                        } else delete h.addons[o];
                        if (c) break
                    }
                }
                await Promise.all(d), r || m.trigger('builder_load_module_partial', [r, n])
            }
        },
        loadModules(e, t) {
            const s = [];
            return s.push(this.touchdropdown(e, t)), !1 === m.is_builder_active && (s.push(this.morePagination(e, t)), !1 === t) && s.push(this.stickyElementInit(m.selectWithParent('[data-sticky-active]', e))), s.push(m.trigger('builder_load_module_partial', [e, t])), s.push(this.addonLoad(e, null, t)), s.push(this.wc(e, t)), s.push(this.wow(e, t)), s.push(this.initScrollHighlight(e, t)), Promise.all(s)
        },
        async wc(e, t) {
            if (!0 !== t && i.wc_single_product_params !== u && ($('.wc-tabs-wrapper, .woocommerce-tabs, #rating', e).each(function() {
                    !this.hasAttribute('tb_done') && (this.dataset.tb_done = 1('tb_done', 1), 'rating' !== this.id || this.parentNode.tfClass('stars')[0]) && $(this).trigger('init')
        ...
        async touchdropdown(t, s) {
            if (m.isTouch) {
                ...
                null !== e && e[0] !== u && (await m.loadCss(this.cssUrl + 'menu_styles/sub_arrow'), m.dropDown(e))
            }
        },
        async stickyElementInit(e) {
            '' === h.is_sticky || !0 === this.isBpMobile && 'm' === h.is_sticky || !e || e[0] === u || (await m.loadJs(this.jsUrl + 'sticky'), m.trigger('tb_sticky_init', [e]))
        },
        async morePagination(e, t) {
            if (!0 !== t || e.classList.contains('tb_ajax_pagination')) {
                const s = m.selectWithParent('tb_ajax_pagination', e);
                if (s[0] !== u) {
                    const i = [];
                    for (let e = s.length - 1; - 1 < e; --e) i.push(m.infinity(s[e], {
...
})(jQuery, window, Themify, document, void 0, tbLocalScript);